...
<div class="cookie-popup fixed max-w-lg bottom-3 end-3 start-3 sm:start-0 mx-auto bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 rounded-md py-5 px-6 z-50">
    ...
    <div class="cookie-popup-actions text-end">
        <button class="absolute border-none bg-none p-0 cursor-pointer font-semibold top-2 end-2"><i class="uil uil-times text-slate-900 dark:text-slate-200 text-2xl"></i></button>
    </div>
</div>
