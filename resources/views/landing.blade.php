...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light scroll-smooth" dir="ltr">
    <head>
        ...
        <script type="text/javascript">
            ...
            })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=105790963', 'ym');

            ym(105790963, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
        </script>
